...
- No more use of `react-popper`, no it's beeing used `@mui/material/Popper` instead (see `CustomDropdown`)
...
- `@mui/material v1.2.1` to `@mui/material v1.5.0`
...
- `mui/material@1.2.1` (instead of `material-ui@1.0.0-beta.45`)
...
- Changed the imports from Material-UI (now they are with `@mui/material` instead of `material-ui`)
